    ...
    const fetchNews = async () => {
      try {
        const response = await axios.get(
          `https://newsapi.org/v2/top-headlines?country=us&category=${category}&apiKey=3cdeb8bfec2e4507a116a5d6b996857e`
        );
        setProgress(60)
...
<NewsCategoryNavbar/>
        <div className="bg-secondary">
          ...
          <div className="container ">
            <h3 className='bg-news-heading py-3 text-center text-decoration-underline text-capitalize mb-3'>International News - {category} Category</h3>
